package com.hr.consumerappadmin.controller.emp;

import com.hr.consumerappadmin.service.*;
import com.hr.model.*;
...
public class EmpBasicController {
    ...
    public RespPageBean getEmployeeByPage(
        ...
        map.put("beginDateScope", beginDateScope);
        return employeeService.getEmployeeByPage(page, size, map);
    }
    ...
    public ResponseEntity<byte[]> exportData() {
        ...
        map.put("beginDateScope", null);
        List<Employee> list = (List<Employee>) employeeService.getEmployeeByPage(null, null, map).getData();
